...
:root{
    --m-deep:#1a3040;--m-mid:#2a5070;--m-bright:#4a90b8;--m-pale:#b8ddf0;--m-ghost:#e8f4fb;
    --b-mid:#ddd0b8;--b-light:#f0e8d8;--b-white:#faf6ee;
    --txt-dark:#0e1f2e;--txt-soft:#3a5570;--txt-muted:#7a9ab8;
    --danger:#b83225;--warning:#c96a08;--safe:#277a44;
    --shadow:0 2px 18px rgba(26,48,64,.09);--r:13px;--sb-w:248px;
}
...
.sb-logo .emblem{width:46px;height:46px;border-radius:12px;background:linear-gradient(135deg,var(--m-bright),var(--m-mid));display:flex;align-items:center;justify-content:center;font-size:22px;margin-bottom:11px;box-shadow:0 4px 12px rgba(74,144,184,.35)}
.sb-logo h2{font-family:'DM Serif Display',serif;color:#fff;font-size:1.08rem;line-height:1.25}
.sb-logo small{color:var(--m-pale);font-size:.68rem;font-weight:300;opacity:.8;display:block;margin-top:3px}
...
.nav-a.active{color:#fff;background:rgba(74,144,184,.22);border-left-color:var(--m-bright)}
...
.avatar{width:36px;height:36px;border-radius:50%;background:linear-gradient(135deg,var(--m-bright),var(--m-mid));display:flex;align-items:center;justify-content:center;color:#fff;font-weight:700;font-size:.86rem;flex-shrink:0}
.uinfo .uname{color:#fff;font-size:.82rem;font-weight:500}
.uinfo .urole{color:var(--m-pale);font-size:.65rem;opacity:.7}
...
.topbar-title{font-family:'DM Serif Display',serif;font-size:1.3rem;color:var(--m-deep)}
...
.kpi::after{content:'';position:absolute;top:0;left:0;right:0;height:3px;background:linear-gradient(90deg,var(--m-mid),var(--m-bright));border-radius:3px 3px 0 0}
...
.kpi.grn::after{background:linear-gradient(90deg,#145a2c,#277a44)}
.kpi:hover{transform:translateY(-3px);box-shadow:0 8px 28px rgba(26,48,64,.14)}
.kpi-ico{font-size:1.6rem;margin-bottom:12px;line-height:1}
.kpi-val{font-family:'DM Serif Display',serif;font-size:2.1rem;color:var(--m-deep);line-height:1}
...
.card-title{font-family:'DM Serif Display',serif;font-size:.98rem;color:var(--m-deep);margin-bottom:2px}
...
.tbl-head{padding:16px 22px;border-bottom:1px solid var(--b-mid);display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:8px}
.tbl-head h3{font-family:'DM Serif Display',serif;font-size:.98rem;color:var(--m-deep)}
...
.btn-verify  {background:#d4f0de;color:#145a2c}
...
.modal{background:var(--b-white);border-radius:16px;padding:30px 32px;width:100%;max-width:420px;box-shadow:0 12px 48px rgba(0,0,0,.22);animation:pop .18s ease}
@keyframes pop{from{transform:scale(.94);opacity:0}to{transform:scale(1);opacity:1}}
.modal h3{font-family:'DM Serif Display',serif;font-size:1.15rem;color:var(--m-deep);margin-bottom:8px}
.modal p{font-size:.85rem;color:var(--txt-soft);margin-bottom:22px;line-height:1.55}
.modal p strong{color:var(--txt-dark)}
.modal-actions{display:flex;gap:10px;justify-content:flex-end}
.btn-cancel{padding:8px 18px;border-radius:8px;background:var(--b-light);border:1px solid var(--b-mid);color:var(--txt-soft);font-size:.84rem;font-family:inherit;cursor:pointer;transition:background .15s}
.btn-cancel:hover{background:var(--b-mid)}
.btn-confirm-verify  {padding:8px 18px;border-radius:8px;background:#145a2c;color:#fff;border:none;font-size:.84rem;font-weight:600;font-family:inherit;cursor:pointer;transition:opacity .15s}
.btn-confirm-unverify{padding:8px 18px;border-radius:8px;background:#8a4200;color:#fff;border:none;font-size:.84rem;font-weight:600;font-family:inherit;cursor:pointer;transition:opacity .15s}
.btn-confirm-verify:hover,.btn-confirm-unverify:hover{opacity:.85}
